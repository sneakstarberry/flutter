                      ...
                      BarChartData(
                        ...
                        barGroups: [
                          BarChartGroupData(
                            x: 0,
                            barRods: [
                              BarChartRodData(y: 14, color: Colors.orange[400]),
                            ],
                          ),
                          BarChartGroupData(
                            x: 1,
                          ...
                          BarChartGroupData(
                            x: 5,
                            barRods: [
                              BarChartRodData(y: 18, color: Colors.orange[400]),
                            ],
                          ),
                          BarChartGroupData(
                            x: 6,
                            barRods: [
                              BarChartRodData(y: 10, color: Colors.orange[400]),
                            ],
                          ),
                          BarChartGroupData(
                            x: 7,
